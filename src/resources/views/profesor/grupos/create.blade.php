...
<div class="max-w-4xl mx-auto">
    <div class="mb-6 flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Nuevo Grupo</h1>
            <p class="text-gray-600">Define un nuevo grupo de alumnos</p>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden">
        <form action="{{ route('grupos.store') }}" method="POST" class="p-8 space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex gap-2">
                        ...
                        <input type="text" value="{{ old('color', '#3B82F6') }}" readonly
            ...
            <div class="space-y-2">
                ...
                <textarea name="descripcion" id="descripcion" rows="4"
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition"
                          placeholder="Propósito del grupo, horarios, etc...">{{ old('descripcion') }}</textarea>
                @error('descripcion')
                    <p class="text-red-500 text-xs">{{ $message }}</p>
                @enderror
            </div>
