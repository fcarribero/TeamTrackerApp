...
@section('breadcrumbs')
    @include('partials.breadcrumbs', ['items' => [
        ...
        ['label' => $otherUser->nombre . ' ' . $otherUser->apellido]
    ]])
@endsection
        ...
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-xs text-green-500 flex items-center gap-1">
                    <span class="w-2 h-2 bg-green-500 rounded-full"></span> Alumno
                </p>
            </div>
        </div>
        <a href="{{ route('mensajes.index') }}" class="text-gray-400 hover:text-gray-600 lg:hidden">
